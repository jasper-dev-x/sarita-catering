...
export default function ServiceDetailBtn({ id, imgLink, service }) {
    ...
    return (
        <div className="col-md-1 d-flex flex-fill justify-content-center py-4 px-md-4">
            <div className="card bg-light shadow" style={ { borderRadius } } onClick={ () => window.scrollTo(0, 0) }>
                <img src={ imgLink } className="d-block mx-lg-auto img-fluid" alt="..." style={ { borderRadius } } />
